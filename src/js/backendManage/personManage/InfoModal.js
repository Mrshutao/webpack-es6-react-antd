  ...
  class RegistrationForm extends Component{
		 ...
		 queryDepartment(){
			...
			render(){
				...
				children=this.state.brchnoli.map((v,index)=>{
					return <Option key={index} value={v.key}>{v.value}</Option>
				})
				return(
					<Form>
            ...
            <Input />
					  ...
					  style={{ width: 285 }}>
						...
						{getFieldDecorator('web', {
							initialValue:this.props.brchno?this.props.brchno:"",
	...
	export default class InfoModal extends Component {
        ...
        message.error(obj);
			...
			render() {
                ...
                <WrappedRegistrationForm ref={(ref)=>this.obj = ref} brchno={this.props.brchno}/>
						</Modal>
					</div>
				);
			}
