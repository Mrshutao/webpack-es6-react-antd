...
import InfoModal from '../personManage/InfoModal';
...
//删除行员
  delete(){
  	let self = this;
		let tranCode="queryBranch/deleteUser"
		var input={
		...
		return(
               ...
               <Row>
                    <div style={{marginTop:20,marginBottom:20}}>
                      ...
                      <Button type="primary" onClick={()=>this.addPerson()} icon="plus">添加</Button>  
                  
                   
                       <Popconfirm title="确定要删除吗？"  onConfirm={()=>this.delete()} okText="确定" cancelText="取消">
              ...
              <InfoModal ref={(ref)=> this.InfoModal = ref} brchno={this.props.brchno}/>
			</div>
